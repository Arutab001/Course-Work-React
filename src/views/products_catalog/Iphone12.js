...
import IphoneMainImg from '../../images/iphone11.png';
...
import iphone13_11Img from '../../images/Iphone_Gallery/iphone12_1.jpg';
        ...
        <div className={styles['container']}>
            ...
            <div className={styles['container2']}>
                <div className={styles['container3']}>
                    ...
                    <h1>1500$</h1>
                    <span>
            iPhone 12 оснащён OLED дисплеем диагональю 6,1 дюйма, произведённым по технологии Super Retina XDR, c разрешением экрана 2532×1170 пикселей и плотностью 460 PPI (пикселей на дюйм). Пиковая яркость 1200 нит. Экран покрыт керамическим покрытием Ceramic Shield[8], произведённым совместно с компанией Corning.
          </span>
